...
with st.expander("⚠️ 免責事項 (必ずお読みください)"):
    ...
    <ul>
    <li>本アプリの予報は、気象予報APIおよび独自のロジックに基づく予測であり、実際の海況や釣果を保証するものではありません。</li>
    <li>自然相手の遊びですので、予報と異なる風や潮が発生することは多々あります。現場の状況を優先してください。</li>
    <li>本アプリの情報を利用したことによる釣果の不振、事故、損害、トラブル等について、開発者は一切の責任を負いかねます。</li>
    <li>最終的な座席決定や出船判断、航行の安全については、必ず船長の指示に従ってください。</li>
    </ul>
    </div>
